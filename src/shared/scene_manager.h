...
namespace Shared
{
	...
	public:
		virtual sky::Action createEnterAction() = 0;
		virtual sky::Action createLeaveAction() = 0;
	};
	...
	public:
		virtual sky::Action createOpenAction() = 0;
		virtual sky::Action createCloseAction() = 0;
	};
}
